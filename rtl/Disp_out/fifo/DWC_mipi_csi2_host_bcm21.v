...
//
// Filename    : DWC_mipi_csi2_host_bcm21.v
// Revision    : $Id: //dwh/mipi_iip/DWC_mipi_csi2_host/main/src/DWC_mipi_csi2_host_bcm21.v#30 $
// Author      : Doug Lee    2/20/05
// Description : DWC_mipi_csi2_host_bcm21.v Verilog module for DWC_mipi_csi2_host
//
// DesignWare IP ID: 02292a14
//
////////////////////////////////////////////////////////////////////////////////



module DWC_mipi_csi2_host_bcm21 (
    clk_d,
    rst_d_n,
    data_s,
    data_d
...
`endif
    ...
    always@(data_s_int) begin
      ...
      endproperty
      COVER_DATA_S_MISSAMPLE:
 cover property (data_s_missample_cov);
    `endif
    `endif
...
`ifdef DWC_SYNC_1_STAGE_SRC
      ...
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1_N(.clk_d(~clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
`else
...
`ifdef DWC_SYNC_2_STAGE_SRC
      DWC_mipi_csi2_host_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
...
`ifdef DWC_SYNC_3_STAGE_SRC
      DWC_mipi_csi2_host_bcm00_sync3 #(WIDTH) U_SAMPLE_META_3(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_2_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_mipi_csi2_host_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
    `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      ...
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(sample_syncm));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm), .data_d(data_d_int));
    `else
      reg    [WIDTH-1:0]      sample_meta;
...
`ifdef DWC_SYNC_4_STAGE_SRC
      DWC_mipi_csi2_host_bcm00_sync4 #(WIDTH) U_SAMPLE_META_4(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_3_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_mipi_csi2_host_bcm00_sync3 #(WIDTH) U_SAMPLE_META_3(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
    `ifdef DWC_SYNC_2_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_mipi_csi2_host_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync2 #(WIDTH) U_SAMPLE_SYNCL_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
    `else
      `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      ...
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM1_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(sample_syncm1));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM2_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm1), .data_d(sample_syncm2));
      DWC_mipi_csi2_host_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm2), .data_d(data_d_int));
      `else
      reg    [WIDTH-1:0]      sample_meta;
      reg    [WIDTH-1:0]      sample_syncm1;
    ...
    for (i=0; i<WIDTH; i=i+1) begin : DATA_S
      property LtoHMonitor;
        @(posedge clk_d_mod) disable iff (!rst_d_n 
          ...
          $rose(data_s[i]);
      endproperty
      COVER_LOW_TO_HIGH_TRANSITION:
 cover property (LtoHMonitor);
      ...
      property HtoLMonitor;
        @(posedge clk_d_mod) disable iff (!rst_d_n 
          ...
          $fell(data_s[i]);
      endproperty
      COVER_HIGH_TO_LOW_TRANSITION:
 cover property (HtoLMonitor);
    end
  end endgenerate
`endif
  ...
  generate
    ...
    if (SVA_TYPE_BIT1BIT0 == 1) begin : GEN_SVATP_EQ_1
      ...
      DWC_mipi_csi2_host_sva01 #(WIDTH, (F_SYNC_TYPE & 7), VERIF_EN) P_SYNC_HS (.*);
    end
    ...
    `endif
      ...
      DWC_mipi_csi2_host_sva05 #(WIDTH, (F_SYNC_TYPE & 7)) P_SYNC_GC (.*);
    end

    if (SVA_TYPE_BIT2 == 0) begin : GEN_SVATP_BIT2_EQ_0
      DWC_mipi_csi2_host_sva08 #(WIDTH) P_SYNC_EQ_RST (.*);
    end
  endgenerate
  `else
    `ifdef DW_MODEL_MISSAMPLES
