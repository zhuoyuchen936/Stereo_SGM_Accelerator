...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa1920x32m4s (user specify : RF2P_1920x32) */
//*        Library Version  : 130a */
//*        Generated Time   : 2023/07/19, 05:45:25 */
//*************************************************************************** ** */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_1920x32_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_1920x32_fault.cde";
`endif
...
RF2P_1920x32_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_1920x32_Int_Array (D, BW, AW, EN, RDB, AR, Q);
