...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa1936x11m4s (user specify : RF2P_1936x11) */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_1936x11_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_1936x11_fault.cde";
`endif
...
reg valid_d10, valid_d9, valid_d8, valid_d7, valid_d6, valid_d5, valid_d4, valid_d3, valid_d2, valid_d1, valid_d0;
reg valid_bw10, valid_bw9, valid_bw8, valid_bw7, valid_bw6, valid_bw5, valid_bw4, valid_bw3, valid_bw2, valid_bw1, valid_bw0;
reg valid_bist;
...
RF2P_1936x11_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_1936x11_Int_Array (D, BW, AW, EN, RDB, AR, Q);
