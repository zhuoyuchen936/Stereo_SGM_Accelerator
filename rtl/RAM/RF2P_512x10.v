...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa512x10m4s (user specify : RF2P_512x10) */
//*        Library Version  : 130a */
//*        Generated Time   : 2023/07/19, 05:45:32 */
//*************************************************************************** ** */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_512x10_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_512x10_fault.cde";
`endif
...
reg valid_d9, valid_d8, valid_d7, valid_d6, valid_d5, valid_d4, valid_d3, valid_d2, valid_d1, valid_d0;
reg valid_bw9, valid_bw8, valid_bw7, valid_bw6, valid_bw5, valid_bw4, valid_bw3, valid_bw2, valid_bw1, valid_bw0;
reg valid_bist;
...
RF2P_512x10_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_512x10_Int_Array (D, BW, AW, EN, RDB, AR, Q);
