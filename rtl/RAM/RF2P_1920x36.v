...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa1920x36m4s (user specify : RF2P_1920x36) */
//*        Library Version  : 130a */
//*        Generated Time   : 2023/07/19, 05:45:22 */
//*************************************************************************** ** */
...
// Input-Output declarations
   input [M-1:0] AA;                // Address write bus   Ð´µØÖ·
   input [N-1:0] D;                 // Date input bus      D
   input [N-1:0] BWEB;              // BW data input bus   Î»Ð´ÐÅºÅ
   input         WEB;               // Active-low Write enable Ð´Ê¹ÄÜ
   input         CLKW;              // Clock A              
   input [M-1:0] AB;                // Address read bus   ¶ÁµØÖ·
   input         REB;               // Active-low Read enable ¶ÁÊ¹ÄÜ
   input         CLKR;              // Clock B 
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_1920x36_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_1920x36_fault.cde";
`endif
...
buf sDM18 (bDM[18], DM[18]);
buf sBWEBM18 (bBWEBM[18], BWEBM[18]);
buf sDM19 (bDM[19], DM[19]);
buf sBWEBM19 (bBWEBM[19], BWEBM[19]);
buf sDM20 (bDM[20], DM[20]);
buf sBWEBM20 (bBWEBM[20], BWEBM[20]);
buf sDM21 (bDM[21], DM[21]);
buf sBWEBM21 (bBWEBM[21], BWEBM[21]);
buf sDM22 (bDM[22], DM[22]);
buf sBWEBM22 (bBWEBM[22], BWEBM[22]);
buf sDM23 (bDM[23], DM[23]);
buf sBWEBM23 (bBWEBM[23], BWEBM[23]);
buf sDM24 (bDM[24], DM[24]);
buf sBWEBM24 (bBWEBM[24], BWEBM[24]);
buf sDM25 (bDM[25], DM[25]);
buf sBWEBM25 (bBWEBM[25], BWEBM[25]);
buf sDM26 (bDM[26], DM[26]);
buf sBWEBM26 (bBWEBM[26], BWEBM[26]);
buf sDM27 (bDM[27], DM[27]);
buf sBWEBM27 (bBWEBM[27], BWEBM[27]);
buf sDM28 (bDM[28], DM[28]);
buf sBWEBM28 (bBWEBM[28], BWEBM[28]);
buf sDM29 (bDM[29], DM[29]);
buf sBWEBM29 (bBWEBM[29], BWEBM[29]);
buf sDM30 (bDM[30], DM[30]);
buf sBWEBM30 (bBWEBM[30], BWEBM[30]);
buf sDM31 (bDM[31], DM[31]);
buf sBWEBM31 (bBWEBM[31], BWEBM[31]);
buf sDM32 (bDM[32], DM[32]);
buf sBWEBM32 (bBWEBM[32], BWEBM[32]);
buf sDM33 (bDM[33], DM[33]);
buf sBWEBM33 (bBWEBM[33], BWEBM[33]);
buf sDM34 (bDM[34], DM[34]);
buf sBWEBM34 (bBWEBM[34], BWEBM[34]);
buf sDM35 (bDM[35], DM[35]);
buf sBWEBM35 (bBWEBM[35], BWEBM[35]);
...
tHOLD = 0.3726155;
  ...
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[18], tDS, tDH, valid_d18);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[18], tDS, tDH, valid_d18);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[18], tDMS, tDMH, valid_d18);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[18], tDMS, tDMH, valid_d18);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[18], tBWS, tBWH, valid_bw18);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[18], tBWS, tBWH, valid_bw18);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[18], tBWMS, tBWMH, valid_bw18);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[18], tBWMS, tBWMH, valid_bw18);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[19], tDS, tDH, valid_d19);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[19], tDS, tDH, valid_d19);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[19], tDMS, tDMH, valid_d19);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[19], tDMS, tDMH, valid_d19);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[19], tBWS, tBWH, valid_bw19);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[19], tBWS, tBWH, valid_bw19);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[19], tBWMS, tBWMH, valid_bw19);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[19], tBWMS, tBWMH, valid_bw19);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[20], tDS, tDH, valid_d20);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[20], tDS, tDH, valid_d20);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[20], tDMS, tDMH, valid_d20);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[20], tDMS, tDMH, valid_d20);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[20], tBWS, tBWH, valid_bw20);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[20], tBWS, tBWH, valid_bw20);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[20], tBWMS, tBWMH, valid_bw20);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[20], tBWMS, tBWMH, valid_bw20);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[21], tDS, tDH, valid_d21);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[21], tDS, tDH, valid_d21);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[21], tDMS, tDMH, valid_d21);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[21], tDMS, tDMH, valid_d21);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[21], tBWS, tBWH, valid_bw21);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[21], tBWS, tBWH, valid_bw21);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[21], tBWMS, tBWMH, valid_bw21);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[21], tBWMS, tBWMH, valid_bw21);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[22], tDS, tDH, valid_d22);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[22], tDS, tDH, valid_d22);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[22], tDMS, tDMH, valid_d22);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[22], tDMS, tDMH, valid_d22);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[22], tBWS, tBWH, valid_bw22);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[22], tBWS, tBWH, valid_bw22);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[22], tBWMS, tBWMH, valid_bw22);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[22], tBWMS, tBWMH, valid_bw22);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[23], tDS, tDH, valid_d23);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[23], tDS, tDH, valid_d23);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[23], tDMS, tDMH, valid_d23);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[23], tDMS, tDMH, valid_d23);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[23], tBWS, tBWH, valid_bw23);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[23], tBWS, tBWH, valid_bw23);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[23], tBWMS, tBWMH, valid_bw23);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[23], tBWMS, tBWMH, valid_bw23);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[24], tDS, tDH, valid_d24);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[24], tDS, tDH, valid_d24);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[24], tDMS, tDMH, valid_d24);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[24], tDMS, tDMH, valid_d24);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[24], tBWS, tBWH, valid_bw24);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[24], tBWS, tBWH, valid_bw24);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[24], tBWMS, tBWMH, valid_bw24);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[24], tBWMS, tBWMH, valid_bw24);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[25], tDS, tDH, valid_d25);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[25], tDS, tDH, valid_d25);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[25], tDMS, tDMH, valid_d25);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[25], tDMS, tDMH, valid_d25);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[25], tBWS, tBWH, valid_bw25);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[25], tBWS, tBWH, valid_bw25);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[25], tBWMS, tBWMH, valid_bw25);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[25], tBWMS, tBWMH, valid_bw25);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[26], tDS, tDH, valid_d26);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[26], tDS, tDH, valid_d26);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[26], tDMS, tDMH, valid_d26);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[26], tDMS, tDMH, valid_d26);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[26], tBWS, tBWH, valid_bw26);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[26], tBWS, tBWH, valid_bw26);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[26], tBWMS, tBWMH, valid_bw26);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[26], tBWMS, tBWMH, valid_bw26);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[27], tDS, tDH, valid_d27);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[27], tDS, tDH, valid_d27);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[27], tDMS, tDMH, valid_d27);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[27], tDMS, tDMH, valid_d27);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[27], tBWS, tBWH, valid_bw27);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[27], tBWS, tBWH, valid_bw27);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[27], tBWMS, tBWMH, valid_bw27);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[27], tBWMS, tBWMH, valid_bw27);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[28], tDS, tDH, valid_d28);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[28], tDS, tDH, valid_d28);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[28], tDMS, tDMH, valid_d28);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[28], tDMS, tDMH, valid_d28);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[28], tBWS, tBWH, valid_bw28);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[28], tBWS, tBWH, valid_bw28);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[28], tBWMS, tBWMH, valid_bw28);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[28], tBWMS, tBWMH, valid_bw28);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[29], tDS, tDH, valid_d29);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[29], tDS, tDH, valid_d29);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[29], tDMS, tDMH, valid_d29);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[29], tDMS, tDMH, valid_d29);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[29], tBWS, tBWH, valid_bw29);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[29], tBWS, tBWH, valid_bw29);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[29], tBWMS, tBWMH, valid_bw29);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[29], tBWMS, tBWMH, valid_bw29);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[30], tDS, tDH, valid_d30);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[30], tDS, tDH, valid_d30);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[30], tDMS, tDMH, valid_d30);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[30], tDMS, tDMH, valid_d30);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[30], tBWS, tBWH, valid_bw30);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[30], tBWS, tBWH, valid_bw30);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[30], tBWMS, tBWMH, valid_bw30);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[30], tBWMS, tBWMH, valid_bw30);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[31], tDS, tDH, valid_d31);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[31], tDS, tDH, valid_d31);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[31], tDMS, tDMH, valid_d31);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[31], tDMS, tDMH, valid_d31);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[31], tBWS, tBWH, valid_bw31);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[31], tBWS, tBWH, valid_bw31);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[31], tBWMS, tBWMH, valid_bw31);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[31], tBWMS, tBWMH, valid_bw31);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[32], tDS, tDH, valid_d32);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[32], tDS, tDH, valid_d32);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[32], tDMS, tDMH, valid_d32);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[32], tDMS, tDMH, valid_d32);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[32], tBWS, tBWH, valid_bw32);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[32], tBWS, tBWH, valid_bw32);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[32], tBWMS, tBWMH, valid_bw32);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[32], tBWMS, tBWMH, valid_bw32);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[33], tDS, tDH, valid_d33);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[33], tDS, tDH, valid_d33);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[33], tDMS, tDMH, valid_d33);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[33], tDMS, tDMH, valid_d33);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[33], tBWS, tBWH, valid_bw33);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[33], tBWS, tBWH, valid_bw33);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[33], tBWMS, tBWMH, valid_bw33);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[33], tBWMS, tBWMH, valid_bw33);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[34], tDS, tDH, valid_d34);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[34], tDS, tDH, valid_d34);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[34], tDMS, tDMH, valid_d34);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[34], tDMS, tDMH, valid_d34);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[34], tBWS, tBWH, valid_bw34);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[34], tBWS, tBWH, valid_bw34);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[34], tBWMS, tBWMH, valid_bw34);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[34], tBWMS, tBWMH, valid_bw34);
  $setuphold (posedge CLKW &&& ANOBIST, posedge D[35], tDS, tDH, valid_d35);
  $setuphold (posedge CLKW &&& ANOBIST, negedge D[35], tDS, tDH, valid_d35);

  $setuphold (posedge CLKW &&& ABIST, posedge DM[35], tDMS, tDMH, valid_d35);
  $setuphold (posedge CLKW &&& ABIST, negedge DM[35], tDMS, tDMH, valid_d35);

  $setuphold (posedge CLKW &&& ANOBIST, posedge BWEB[35], tBWS, tBWH, valid_bw35);
  $setuphold (posedge CLKW &&& ANOBIST, negedge BWEB[35], tBWS, tBWH, valid_bw35);

  $setuphold (posedge CLKW &&& ABIST, posedge BWEBM[35], tBWMS, tBWMH, valid_bw35);
  $setuphold (posedge CLKW &&& ABIST, negedge BWEBM[35], tBWMS, tBWMH, valid_bw35);
 ...
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[18] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[18] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[19] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[19] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[20] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[20] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[21] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[21] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[22] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[22] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[23] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[23] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[24] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[24] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[25] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[25] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[26] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[26] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[27] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[27] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[28] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[28] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[29] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[29] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[30] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[30] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[31] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[31] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[32] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[32] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[33] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[33] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[34] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[34] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REB & !BIST)(posedge CLKR => (Q[35] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 if (!PD & !REBM & BIST)(posedge CLKR => (Q[35] : 1'bx)) = (tCD,tCD,tHOLD,tCD,tHOLD,tCD);
 ...
 (posedge PD => (Q[18] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[19] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[20] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[21] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[22] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[23] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[24] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[25] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[26] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[27] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[28] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[29] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[30] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[31] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[32] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[33] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[34] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
 (posedge PD => (Q[35] +: 1'bx)) =  (0.0,tCD,0.0,0.0,0.0,tCD);
...
always @(bPD or DM[18] or BIST) begin
  if (bPD === 1'b1 && DM[18] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[18] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[18] or BIST) begin
  if (bPD === 1'b1 && BWEBM[18] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[18] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[19] or BIST) begin
  if (bPD === 1'b1 && DM[19] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[19] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[19] or BIST) begin
  if (bPD === 1'b1 && BWEBM[19] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[19] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[20] or BIST) begin
  if (bPD === 1'b1 && DM[20] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[20] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[20] or BIST) begin
  if (bPD === 1'b1 && BWEBM[20] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[20] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[21] or BIST) begin
  if (bPD === 1'b1 && DM[21] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[21] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[21] or BIST) begin
  if (bPD === 1'b1 && BWEBM[21] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[21] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[22] or BIST) begin
  if (bPD === 1'b1 && DM[22] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[22] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[22] or BIST) begin
  if (bPD === 1'b1 && BWEBM[22] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[22] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[23] or BIST) begin
  if (bPD === 1'b1 && DM[23] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[23] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[23] or BIST) begin
  if (bPD === 1'b1 && BWEBM[23] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[23] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[24] or BIST) begin
  if (bPD === 1'b1 && DM[24] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[24] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[24] or BIST) begin
  if (bPD === 1'b1 && BWEBM[24] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[24] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[25] or BIST) begin
  if (bPD === 1'b1 && DM[25] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[25] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[25] or BIST) begin
  if (bPD === 1'b1 && BWEBM[25] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[25] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[26] or BIST) begin
  if (bPD === 1'b1 && DM[26] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[26] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[26] or BIST) begin
  if (bPD === 1'b1 && BWEBM[26] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[26] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[27] or BIST) begin
  if (bPD === 1'b1 && DM[27] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[27] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[27] or BIST) begin
  if (bPD === 1'b1 && BWEBM[27] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[27] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[28] or BIST) begin
  if (bPD === 1'b1 && DM[28] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[28] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[28] or BIST) begin
  if (bPD === 1'b1 && BWEBM[28] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[28] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[29] or BIST) begin
  if (bPD === 1'b1 && DM[29] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[29] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[29] or BIST) begin
  if (bPD === 1'b1 && BWEBM[29] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[29] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[30] or BIST) begin
  if (bPD === 1'b1 && DM[30] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[30] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[30] or BIST) begin
  if (bPD === 1'b1 && BWEBM[30] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[30] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[31] or BIST) begin
  if (bPD === 1'b1 && DM[31] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[31] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[31] or BIST) begin
  if (bPD === 1'b1 && BWEBM[31] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[31] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[32] or BIST) begin
  if (bPD === 1'b1 && DM[32] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[32] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[32] or BIST) begin
  if (bPD === 1'b1 && BWEBM[32] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[32] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[33] or BIST) begin
  if (bPD === 1'b1 && DM[33] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[33] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[33] or BIST) begin
  if (bPD === 1'b1 && BWEBM[33] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[33] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[34] or BIST) begin
  if (bPD === 1'b1 && DM[34] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[34] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[34] or BIST) begin
  if (bPD === 1'b1 && BWEBM[34] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[34] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or DM[35] or BIST) begin
  if (bPD === 1'b1 && DM[35] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input DM[35] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEBM[35] or BIST) begin
  if (bPD === 1'b1 && BWEBM[35] === 1'bz && bBIST !== 1'b0) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEBM[35] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[18] or BIST) begin
  if (bPD === 1'b1 && D[18] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[18] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[18] or BIST) begin
  if (bPD === 1'b1 && BWEB[18] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[18] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[19] or BIST) begin
  if (bPD === 1'b1 && D[19] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[19] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[19] or BIST) begin
  if (bPD === 1'b1 && BWEB[19] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[19] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[20] or BIST) begin
  if (bPD === 1'b1 && D[20] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[20] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[20] or BIST) begin
  if (bPD === 1'b1 && BWEB[20] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[20] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[21] or BIST) begin
  if (bPD === 1'b1 && D[21] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[21] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[21] or BIST) begin
  if (bPD === 1'b1 && BWEB[21] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[21] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[22] or BIST) begin
  if (bPD === 1'b1 && D[22] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[22] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[22] or BIST) begin
  if (bPD === 1'b1 && BWEB[22] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[22] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[23] or BIST) begin
  if (bPD === 1'b1 && D[23] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[23] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[23] or BIST) begin
  if (bPD === 1'b1 && BWEB[23] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[23] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[24] or BIST) begin
  if (bPD === 1'b1 && D[24] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[24] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[24] or BIST) begin
  if (bPD === 1'b1 && BWEB[24] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[24] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[25] or BIST) begin
  if (bPD === 1'b1 && D[25] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[25] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[25] or BIST) begin
  if (bPD === 1'b1 && BWEB[25] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[25] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[26] or BIST) begin
  if (bPD === 1'b1 && D[26] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[26] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[26] or BIST) begin
  if (bPD === 1'b1 && BWEB[26] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[26] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[27] or BIST) begin
  if (bPD === 1'b1 && D[27] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[27] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[27] or BIST) begin
  if (bPD === 1'b1 && BWEB[27] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[27] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[28] or BIST) begin
  if (bPD === 1'b1 && D[28] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[28] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[28] or BIST) begin
  if (bPD === 1'b1 && BWEB[28] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[28] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[29] or BIST) begin
  if (bPD === 1'b1 && D[29] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[29] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[29] or BIST) begin
  if (bPD === 1'b1 && BWEB[29] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[29] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[30] or BIST) begin
  if (bPD === 1'b1 && D[30] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[30] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[30] or BIST) begin
  if (bPD === 1'b1 && BWEB[30] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[30] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[31] or BIST) begin
  if (bPD === 1'b1 && D[31] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[31] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[31] or BIST) begin
  if (bPD === 1'b1 && BWEB[31] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[31] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[32] or BIST) begin
  if (bPD === 1'b1 && D[32] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[32] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[32] or BIST) begin
  if (bPD === 1'b1 && BWEB[32] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[32] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[33] or BIST) begin
  if (bPD === 1'b1 && D[33] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[33] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[33] or BIST) begin
  if (bPD === 1'b1 && BWEB[33] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[33] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[34] or BIST) begin
  if (bPD === 1'b1 && D[34] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[34] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[34] or BIST) begin
  if (bPD === 1'b1 && BWEB[34] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[34] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or D[35] or BIST) begin
  if (bPD === 1'b1 && D[35] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[35] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(bPD or BWEB[35] or BIST) begin
  if (bPD === 1'b1 && BWEB[35] === 1'bz && bBIST !== 1'b1) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[35] high-Z during Power Down Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
RF2P_1920x36_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_1920x36_Int_Array (D, BW, AW, EN, RDB, AR, Q);
