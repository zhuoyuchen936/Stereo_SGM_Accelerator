...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa1936x33m4s (user specify : RF2P_1936x33) */
//*        Library Version  : 130a */
//*        Generated Time   : 2017/03/14, 21:53:03 */
//*************************************************************************** ** */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_1936x33_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_1936x33_fault.cde";
`endif
...
RF2P_1936x33_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_1936x33_Int_Array (D, BW, AW, EN, RDB, AR, Q);
