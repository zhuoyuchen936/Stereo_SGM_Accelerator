...
//*                           with BIST Interface */
//*        Library Name     : ts6n40lpa1936x22m4s (user specify : RF2P_1936x22) */
//*        Library Version  : 130a */
//*        Generated Time   : 2017/03/14, 21:53:02 */
//*************************************************************************** ** */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "RF2P_1936x22_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "RF2P_1936x22_fault.cde";
`endif
...
reg valid_d21, valid_d20, valid_d19, valid_d18, valid_d17, valid_d16, valid_d15, valid_d14, valid_d13, valid_d12, valid_d11, valid_d10, valid_d9, valid_d8, valid_d7, valid_d6, valid_d5, valid_d4, valid_d3, valid_d2, valid_d1, valid_d0;
reg valid_bw21, valid_bw20, valid_bw19, valid_bw18, valid_bw17, valid_bw16, valid_bw15, valid_bw14, valid_bw13, valid_bw12, valid_bw11, valid_bw10, valid_bw9, valid_bw8, valid_bw7, valid_bw6, valid_bw5, valid_bw4, valid_bw3, valid_bw2, valid_bw1, valid_bw0;
reg valid_bist;
...
RF2P_1936x22_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
module RF2P_1936x22_Int_Array (D, BW, AW, EN, RDB, AR, Q);
